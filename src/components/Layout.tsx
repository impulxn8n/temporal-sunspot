...
import { LayoutDashboard, Receipt, Users, Briefcase, CreditCard, PieChart, PlusCircle, Sparkles, Calendar, Trash2, Cloud, RefreshCw, Menu, X, LogOut, CloudDownload, Database, ArrowLeftRight, ArrowDownRight, FileText, HandCoins } from 'lucide-react';
...
const navItems = [
  ...
  { name: 'Prestado', path: '/dinero-prestado', icon: HandCoins },
  { name: 'Presupuesto', path: '/presupuesto', icon: PieChart },
  { name: 'Gastos Fijos', path: '/gastos-fijos', icon: FileText },
